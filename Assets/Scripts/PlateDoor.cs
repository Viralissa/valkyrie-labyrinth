...
namespace UnityStandardAssets.Characters.FirstPerson
{
    public class PlateDoor : MonoBehaviour
    {
        ...
        [SerializeField] private CenterPlate CP;
        [SerializeField] private Rightplate RP;
        [SerializeField] private LeftPlate LP;
        ...
        public void Action() // void to open/close door
        {
            if (!Locked)
            {
                ...
                // opening/closing
                if (isOpened && CanClose && RP._rightplate && LP._leftplate && CP._centerplate == false)
                {
                    isOpened = false;
                }
                else if (!isOpened && CanOpen && RP._rightplate && LP._leftplate && CP._centerplate == false)
                {
                    isOpened = true;
